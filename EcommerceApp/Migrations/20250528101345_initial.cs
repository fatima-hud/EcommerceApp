           ...
           migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColorCompartible = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ColorCompartibleHex = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompartibleColors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAdmin = table.Column<string>(type: "nvarchar(255)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountSettingId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_DiscountSettings_DiscountSettingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    SearchQuery = table.Column<string>(type: "nvarchar(255)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothingItems_ProductId",
                table: "ClothingItems",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_DiscountSettingId",
                table: "Products",
